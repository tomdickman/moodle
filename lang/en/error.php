...
$string['cannotdisabledefaultlicense'] = 'Site default license cannot be disabled.';
...
$string['licensecantdeletecore'] = 'Cannot delete a Moodle core license';
$string['licensenotfoundshortname'] = 'No license with short name {$a} found';
