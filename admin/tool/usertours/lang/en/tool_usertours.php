...
$string['filter_account_creation'] = 'Account creation';
...
$string['filter_first_login'] = 'First login';
...
$string['filter_last_login'] = 'Last login';
$string['filter_last_update'] = 'Last update';
...
$string['filter_shown'] = 'Base Date';
$string['filter_shown_help'] = 'Set the base date/time from which to determine whether a user is shown the tour. (Default: Last update)';
$string['filter_showntime'] = 'Range';
$string['filter_showntime_help'] = 'The duration from base date/time which determines whether a user is shown the tour. (Default: 90 days)';
